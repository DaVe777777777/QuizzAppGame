...
public class PCA_TT_GM_ACTIVITY extends AppCompatActivity {
    ...
    private void showExitConfirmation() {
        ...
        titleView.setTextColor(getResources().getColor(android.R.color.holo_red_dark)); // Red for warning
        ...
        builder.setCustomTitle(titleView) // Use custom title
                ...
                .setCancelable(false)
                .setPositiveButton("Yes", (dialog, which) -> exitToPCAActivity()) // Updated exit function
