...
public class PHNIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phni);
        setTitle("Game Mode");
        ...
        btnTimeTrial.setOnClickListener(view -> {
            ...
            startActivity(new Intent(PHNIActivity.this, PHNI_TT_ACTIVITY.class));
        });

        btnSurvivalMode.setOnClickListener(view -> {
            MainActivity.stopMusic();
            startActivity(new Intent(PHNIActivity.this, PHNI_SM_ACTIVITY.class));
        });

        btnFastMatch.setOnClickListener(view -> {
            MainActivity.stopMusic();
            startActivity(new Intent(PHNIActivity.this, PHNI_FM_ACTIVITY.class));
        });

        btnBack.setOnClickListener(view -> {
            Intent intent = new Intent(PHNIActivity.this, CategoryActivity.class);
    ...
    private void updateProgress() {
        ...
        int ttProgress = getProgressFromDB(dbHelper.getPHNITTProgress(userId));
        int smProgress = getProgressFromDB(dbHelper.getPHNISMProgress(userId));
        int fmProgress = getProgressFromDB(dbHelper.getPHNIFMProgress(userId));
